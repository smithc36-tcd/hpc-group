...
where $N$ is the number of processes and $t$ is the execution time per instrucation,assuming that every operation spends only one cycle(including load and store),and $NumIter=1000000000$ in this case.
